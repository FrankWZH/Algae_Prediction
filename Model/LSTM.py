...
class LSTM:
    ...
    def set_optimizer(self):
        return tfa.optimizers.CyclicalLearningRate(initial_learning_rate=1e-08, maximal_learning_rate=1e-03,
    ...
    def build_model(self):
        ...
        self.model.add(Dense(units=384, activation=self.activation))
