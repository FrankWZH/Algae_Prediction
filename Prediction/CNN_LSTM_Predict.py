...
model = CNN_LSTM(input_unit, filters, kernel_size, activation, x_train, y_train,
                 (x_val, y_val), epoch, batch_size)
...
datamonitor.plot_results(y_pred_actual, y_test_inv, history, 'CNN-LSTM',
